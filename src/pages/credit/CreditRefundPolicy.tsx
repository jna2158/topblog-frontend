  ...
  return (
    <section className="px-32 py-16">
      ...
      <p className="text-gray-500 bg-gray-100 p-4 rounded-lg">
        ...
        <br />
        &nbsp;- 차감율(0.8): 카드 수수료 및 운영비용 20%를 차감한 값을 의미하며,
        환불 금액 산정 시 적용됩니다.
        <br />
        <br />
        가. 환불 금액 산정 기준
        ...
        <br />
        <br />
        실제 결제 금액은 할인율 적용 후 지급된 금액이며, 0.8은 카드 수수료 및
        운영비용 20%를 차감한 값입니다.
        <br />
        <br />
        나. 전액 환불 조건
        <br />
        크레딧 구매 후 24시간 이내에, 단 한 개의 크레딧도 사용되지 않은 경우
        전액 환불이 가능합니다.
        <br />
        <br />
        다. 부분 사용 시 환불 산정
        ...
        정책 위반으로 계정이 정지된 경우에도 환불이 불가능하고, 천재지변, 질병
        등 불가피한 사유 또는 서비스 자체의 중대한 문제(예: 장기간 서버 장애)로
        인해 정상적인 이용이 어려운 경우에는 회사가 예외적으로 환불 요청을
        검토할 수 있으며, 이와 관련한 예외 사항의 판단 및 적용은 회사의 내부
        심사 기준에 따릅니다.
        <br />
        <br />
        마. 환불 절차
        ...
        회사는 신청 내역을 확인하여 7영업일 이내에 환불 처리를 완료하고, 환불
