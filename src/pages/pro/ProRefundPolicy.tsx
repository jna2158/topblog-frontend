  ...
  return (
    <section className="px-32 py-16">
      ...
      <p className="text-gray-500 bg-gray-100 p-4 rounded-lg">
        ...
        <br />
        &nbsp; - 3개월권(정가 66000원, 90일) 3일 이내 전액 환불 가능하며, 30일
        초과 사용 시 환불 불가합니다.
        <br />
        &nbsp; - 12개월권(정가 264000원, 365일) 7일 이내 전액 환불 가능하며,
        ...
        <br />
        환불 금액은 원 결제 수단으로 지급됩니다.
        <br />
        <br />
        마. 환불 신청 우선순위
        <br />
        환불 신청은 구매일 순서가 아닌, 최신 구매 내역 기준으로 처리됩니다. 즉,
        최근에 구매한 상품의 환불 요청이 우선적으로 처리되며, 예를 들어 2025년
        2월에 90일권과 2025년 3월에 180일권을 구매한 경우에는 3월 상품의 환불
        신청이 먼저 완료된 후, 이후에 2월 상품의 환불 신청이 가능합니다.
        <br />
        <br />
        본 환불 정책은 회원의 권리를 보호하는 동시에 공정한 서비스 운영을 위한
        기준으로 적용됩니다.
        <br />
      </p>
    </section>
